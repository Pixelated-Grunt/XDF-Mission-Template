...
// Place ERV respawn point with ACE and without ACE, someone needs to carry the PRC77 radio
if (isClass(configFile >> "CfgPatches" >> "ace_main")) then {
    ...
    _player addAction
    [
        "<t color='#468dca'>Set ERV",
        {
            params ["_target", "_caller", "_actionId", "_arguments"];
            private _group = groupId group _caller;
            private _markerName = format["respawn_west_%1", _group];
            private _markerText = format["%1 ERV", _group];
            openMap true;
            [_markerName, _markerText] onMapSingleClick {
        ...
        true,
        "",
        "[_this, ""ACRE_PRC77""] call acre_api_fnc_hasKindofradio",
        1,
        false,
        "",
        ""
