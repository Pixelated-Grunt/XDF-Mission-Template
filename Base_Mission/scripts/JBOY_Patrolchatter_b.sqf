...
_grpB = _this select 0;
_intervalB = _this select 1;
...
_random_soundB = selectRandom _soundB; [_memberB,[_random_soundB,250,1]] remoteExec ["say3D",0]
};
